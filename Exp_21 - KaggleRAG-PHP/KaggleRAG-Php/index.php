...
<head>
<meta charset="utf-8">
<title>KaggleRAG Demo</title>

<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="description" content="RAG web app to answer questions on the Kaggle platform.">
  ...
  <div class="left-column">
    <main id="chat">
      <div class="message-container">
			  ...
			  <p>Ask questions about the Kaggle platform
		    	</p>
			
	        <p class="info-text">- What's the best way to get started on Kaggle?<br>
				- What actions are prohibited on Kaggle?<br>
				- Are there any Kaggle team members who worked at Microsoft?<br>
				- Does Kaggle track my use of the site?<br>
				- How do I make a competition submission?
	        </p>
			
			<p class="info-text">
				prompt =<br>
Text containing information:<br>
{$context_string}<br>
Question: {$user_query}<br>

Extract the answer to the question from the text provided. <br>
If the text doesn't contain the answer,<br>
	reply that the answer is not available.<br>
Answer at the level that a high school student would understand.<br>
Format you output using paragraph tags.<br>
Separate sentences into paragraphs to improve readability.<br>
Respond as if you are part of the Kaggle team.
  ...
  <div class="right-column w3-black w3-padding">
	...
	<p>KaggleRAG - Demo<br>
		<i>Kaggle virtual assistant</i><br>
	</p>
	
	<p>Here are the text chunks that are in $context_string:</p>
